...
def main():
    EPSILON = 0.3
    MODEL_WEIGHTS_PATH = os.path.join(PROJECT_ROOT, 'model_weights', 'resnet18', 'mnist', 'resnet18_mnist_mtl_ibp_3.pt')
    ...
    # Save to JSON
    out_file = os.path.join(PROJECT_ROOT, 'jsons', 'resnet18', 'mnist', 'resnet18_mnist_mtl_ibp_harmful_channels.json')

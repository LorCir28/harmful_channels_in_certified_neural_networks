...
def main():
    ...
    json_path = os.path.join(PROJECT_ROOT, 'jsons', 'cnn7', 'mnist', 'cnn7_mnist_ibp_scores.json')
    ...
    out_path = os.path.join(out_dir, 'cnn7_mnist_ibp_l2.pt')

    pretrained_path = os.path.join(PROJECT_ROOT, 'model_weights', 'cnn7', 'mnist', 'cnn7_mnist_ibp_2.pt')
    ...
    base_wrapper = ShiIBPModelWrapper(
        model=temp_model, 

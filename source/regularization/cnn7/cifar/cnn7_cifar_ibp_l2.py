...
def main():
    ...
    json_path = os.path.join(PROJECT_ROOT, 'jsons', 'cnn7', 'cifar', 'cnn7_cifar_ibp_scores.json')
    ...
    out_path = os.path.join(out_dir, 'cnn7_cifar_ibp_l2.pt')
    ...
    pretrained_path = os.path.join(PROJECT_ROOT, 'model_weights', 'cnn7', 'cifar', 'cnn7_cifar_ibp_8.pt')

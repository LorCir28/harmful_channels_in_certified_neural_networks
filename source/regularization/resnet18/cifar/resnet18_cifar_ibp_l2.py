...
from source.training.resnet18.cifar.resnet18_cifar_ibp_training import CIFAR_ResNet18
...
def main():
    ...
    json_path = os.path.join(PROJECT_ROOT, 'jsons', 'resnet18', 'cifar', 'resnet18_cifar_ibp_scores.json')
    ...
    # Override the regularizer in the shi_ibp module
    ...
    pretrained_path = os.path.join(PROJECT_ROOT, 'model_weights', 'resnet18', 'cifar', 'resnet18_cifar_ibp_8.pt')
    ...
    out_path = os.path.join(out_dir, f'resnet18_cifar_ibp_l2.pt')

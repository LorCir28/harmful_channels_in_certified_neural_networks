...
from source.training.resnet18.mnist.resnet18_mnist_crown_ibp_training import MNIST_ResNet18
...
def main():
    ...
    # CROWN-IBP specific parameters from training script
    GRADIENT_CLIP = 10
    SHI_REG_WEIGHT = 0.0
    START_BETA = 1.0
    END_BETA = 0.0
    ...
    json_path = os.path.join(PROJECT_ROOT, 'jsons', 'resnet18', 'mnist', 'resnet18_mnist_crown_ibp_scores.json')
    ...
    out_path = os.path.join(out_dir, 'resnet18_mnist_crown_ibp_l2.pt')
    ...
    pretrained_path = os.path.join(PROJECT_ROOT, 'model_weights', 'resnet18', 'mnist', 'resnet18_mnist_crown_ibp_3.pt')

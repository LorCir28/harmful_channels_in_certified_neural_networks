...
MODELS = {
    'ibp': {
        'pt': 'resnet18_cifar_ibp_8.pt',
        'json': 'resnet18_cifar_ibp_harmful_channels.json',
        'display_name': 'IBP'
    },
    'crown-ibp': {
        'pt': 'resnet18_cifar_crown_ibp_8.pt',
        'json': 'resnet18_cifar_crown_ibp_harmful_channels.json',
        'display_name': 'CROWN-IBP'
    },
    'sabr': {
        'pt': 'resnet18_cifar_sabr_8.pt',
        'json': 'resnet18_cifar_sabr_harmful_channels.json',
        'display_name': 'SABR'
    },
    'mtl-ibp': {
        'pt': 'resnet18_cifar_mtl_ibp_8.pt',
        'json': 'resnet18_cifar_mtl_ibp_harmful_channels.json',
...
def main():
    ...
    for model_key, cfg in MODELS.items():
        ...
        model_path = os.path.join(PROJECT_ROOT, 'model_weights', 'resnet18', 'cifar', cfg['pt'])
        json_path = os.path.join(PROJECT_ROOT, 'jsons', 'resnet18', 'cifar', cfg['json'])

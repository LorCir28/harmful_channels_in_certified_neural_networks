...
MODELS = {
    'ibp': {
        'pt': 'cnn7_mnist_ibp_3.pt',
        'json': 'cnn7_mnist_ibp_harmful_channels.json',
        'display_name': 'IBP'
    },
    'crown-ibp': {
        'pt': 'cnn7_mnist_crown_ibp_3.pt',
        'json': 'cnn7_mnist_crown_ibp_harmful_channels.json',
        'display_name': 'CROWN-IBP'
    },
    'sabr': {
        'pt': 'cnn7_mnist_sabr_3.pt',
        'json': 'cnn7_mnist_sabr_harmful_channels.json',
        'display_name': 'SABR'
    },
    'mtl-ibp': {
        'pt': 'cnn7_mnist_mtl_ibp_3.pt',
        'json': 'cnn7_mnist_mtl_ibp_harmful_channels.json',
...
def main():
    ...
    for model_key, cfg in MODELS.items():
        ...
        model_path = os.path.join(PROJECT_ROOT, 'model_weights', 'cnn7', 'mnist', cfg['pt'])
        json_path = os.path.join(PROJECT_ROOT, 'jsons', 'cnn7', 'mnist', cfg['json'])

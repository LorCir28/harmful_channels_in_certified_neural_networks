...
def main():
    ...
    print(f"Using {len(train_ds)} samples for CROWN-IBP training.")
    ...
    out_dir = os.path.join(PROJECT_ROOT, 'model_weights', 'cnn7', 'cifar', 'cnn7_crown_ibp')
    ...
    out_path = os.path.join(out_dir, 'cnn7_crown_ibp_final.pt')

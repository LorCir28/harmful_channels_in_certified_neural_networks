...
def main():
    ...
    print(f"Using {len(train_ds)} samples for IBP training.")
    ...
    out_dir = os.path.join(PROJECT_ROOT, 'model_weights', 'cnn7', 'cifar', 'cnn7_cifar_ibp_2')
    os.makedirs(out_dir, exist_ok=True)
    
    # Wrap model for IBP training
    ...
    out_path = os.path.join(out_dir, 'cnn7_cifar_ibp_2.pt')

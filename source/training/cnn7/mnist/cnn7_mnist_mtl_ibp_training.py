...
# ==========================================
# From resnet18_mnist_ibp_training.py
BATCH_SIZE = 256
EPSILON = 0.1
NUM_EPOCHS = 70
LR = 0.0005
...
# MTL-IBP Specific (using defaults from wrapper)
MTL_IBP_ALPHA = 0.02
PGD_STEPS = 1
PGD_ALPHA = 10.0
PGD_RESTARTS = 1
...
def main():
    ...
    out_dir = os.path.abspath(os.path.join(PROJECT_ROOT, 'model_weights', 'cnn7', 'mnist', 'cnn7_mnist_mtl_ibp_1'))
    ...
    out_path = os.path.join(out_dir, 'cnn7_mnist_mtl_ibp_1.pt')
    ...
    out_path_main = os.path.join(out_dir_main, 'cnn7_mnist_mtl_ibp_1.pt')

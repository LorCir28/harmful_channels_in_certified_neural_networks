...
def main():
    ...
    print(f"Using {len(train_ds)} samples for MTL IBP training.")
    ...
    out_dir = os.path.join(PROJECT_ROOT, 'model_weights', 'resnet18', 'cifar', 'resnet18_mtl_ibp')
    ...
    out_path = os.path.join(out_dir, 'resnet18_mtl_ibp_8_final.pt')
